SELECT u.id AS 'userid', r.id AS 'roleid', u.username, CONCAT(u.firstname,' ', u.lastname) AS 'user_names', c.shortname AS 'coursename', c.id AS 'courseid', cc.id AS 'categoryid', cc.name AS 'categoryname', ccc.name AS 'parent1categoryname', r.shortname AS 'role_shortname'
FROM prefix_user u
